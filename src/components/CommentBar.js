...
export default function CommentBar({ section, commentShow, toggleComment }) {
  ...
  const commentSidebarClasses = classNames(
    "w-[80vw] md:w-[420px] h-[100vh] z-10 fixed inset-y-0 right-0 transition-transform duration-300  ease-in-out transform bg-slate-100 p-4 rounded-l-lg drop-shadow-2xl",
    {
